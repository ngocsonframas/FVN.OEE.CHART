...
namespace FVN.OEE.CHART.Commons
{
    public static class dataOperation
    {
        ...
        //Exec Store Procedure Son IT
        public static SqlDataReader ExecuteStore(int db, string procName, string[] paramName, string[] paramValue)
        {
