namespace System
{
    partial class MSharpExtensions
    {
        ...
        /// </summary>
        public static DateTime ToDateFromOA(this double value) => DateTime.FromOADate(value);
        ...
        /// </summary>
        public static double ToRadians(this double degrees) => Math.PI * degrees / 180;
        ...
        public static float LimitWithin(this float value, float minValue, float maxValue)
        {
            return value.LimitMin(minValue).LimitMax(maxValue);
        }
        ...
        public static double LimitWithin(this double value, double minValue, double maxValue)
        {
            return value.LimitMin(minValue).LimitMax(maxValue);
        }
