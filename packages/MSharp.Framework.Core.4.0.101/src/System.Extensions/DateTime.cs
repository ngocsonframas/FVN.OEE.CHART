namespace System
{
    ...
    partial class MSharpExtensions
    {
        ...
        public static bool IsEnglishHoliday(this DateTime date)
        {
            ...
            if (date == GetBoxingDay(date.Year)) return true;
            ...
            try
            {
                ...
                // Good Friday
                if (date == easterMonday.AddDays(-3)) return true;
            }
            catch { /* out of supported range*/ }

            // Additional Holidays
            if (IsAdditionalBankHoliday(date)) return true;
...
new DateTime(2099,04,13)};
        ...
        {
            return date.GetBeginningOfQuarter().AddMonths(4).GetBeginningOfQuarter().AddTicks(-1);
        }
        ...
        {
            return date.GetBeginningOfMonth().AddMonths(1).AddTicks(-1);
        }
        ...
        /// </summary>
        public static DateTime AddWeeks(this DateTime date, int numberofWeeks) => date.AddDays(7 * numberofWeeks);
