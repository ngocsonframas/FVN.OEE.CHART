namespace System
{
    ...
    partial class MSharpExtensions
    {
        ...
        static string GetRegularPlural(string singular)
        {
            ...
            else secondEnding = char.MinValue;
        ...
        {
            return text.Remove(firstSubstringsToRemove).Remove(otherSubstringsToRemove);
        }
        ...
        [Obsolete("Either use KeepReplacing method (if you really need it) or use Replace method (which already looks for all instances in the string anyway).")]
        public static string ReplaceAll(this string text, string original, string substitute)
        {
            return text.KeepReplacing(original, substitute);
        }
        ...
        [Obsolete("Do not use this method. If you want the encoding signature, use the constructor of your encoding to specify that.")]
        ...
        /// </summary>
        public static FileInfo AsFile(this string path) => new IO.FileInfo(path);
        ...
        public static string CreateMD5Hash(this string clearText, bool asHex = false)
        {
            ...
            else return Convert.ToBase64String(value);
        }
