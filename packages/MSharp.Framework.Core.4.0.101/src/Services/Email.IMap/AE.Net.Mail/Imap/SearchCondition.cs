...
namespace AE.Net.Mail
{
    public class SearchCondition
    {
        ...
        public static SearchCondition Answered() => new SearchCondition { Field = Fields.Answered };

        public static SearchCondition Deleted() => new SearchCondition { Field = Fields.Deleted };

        public static SearchCondition Draft() => new SearchCondition { Field = Fields.Draft };

        public static SearchCondition Flagged() => new SearchCondition { Field = Fields.Flagged };

        public static SearchCondition New() => new SearchCondition { Field = Fields.New };

        public static SearchCondition Old() => new SearchCondition { Field = Fields.Old };

        public static SearchCondition Recent() => new SearchCondition { Field = Fields.Recent };

        public static SearchCondition Seen() => new SearchCondition { Field = Fields.Seen };

        public static SearchCondition Unanswered() => new SearchCondition { Field = Fields.Unanswered };

        public static SearchCondition Undeleted() => new SearchCondition { Field = Fields.Undeleted };

        public static SearchCondition Undraft() => new SearchCondition { Field = Fields.Undraft };

        public static SearchCondition Unflagged() => new SearchCondition { Field = Fields.Unflagged };

        public static SearchCondition Unseen() => new SearchCondition { Field = Fields.Unseen };
        ...
        static SearchCondition Join(string condition, SearchCondition left, params SearchCondition[] right)
        {
        ...
        public virtual SearchCondition Not(params SearchCondition[] other) => Join("NOT", this, other);

        public virtual SearchCondition Or(params SearchCondition[] other) => Join("OR", this, other);
