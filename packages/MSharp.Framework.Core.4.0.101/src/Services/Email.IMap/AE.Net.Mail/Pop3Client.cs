...
namespace AE.Net.Mail
{
    public class Pop3Client : TextClient, IMailClient
    {
        ...
        {
            if (_Stream != null) SendCommand("QUIT");
        }
        ...
        static Regex RxOctets = new Regex(@"(\d+)\s+octets", RegexOptions.IgnoreCase);
        ...
        public virtual void DeleteMessage(string uid) => SendCommandCheckOK("DELE " + uid);

        public virtual void DeleteMessage(int index) => DeleteMessage((index + 1).ToString());
