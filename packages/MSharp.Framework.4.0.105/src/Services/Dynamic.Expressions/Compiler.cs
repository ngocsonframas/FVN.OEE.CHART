...
namespace MSharp.Framework.Services
{
    internal class Compiler
    {
        ...
        static ConcurrentDictionary<Assembly, string> AssemblyFullNames = new ConcurrentDictionary<Assembly, string>();
        static string GetAssemblyFullName(Assembly assembly)
        {
            return AssemblyFullNames.GetOrAdd(assembly, a => a.GetName().FullName);
        }
        ...
        public void Reference(Assembly assembly, bool ignoreFailedAssemblies = false)
        {
            ...
            foreach (var name in assembly.GetReferencedAssemblies())
            {
                ...
                {
                    if (!ignoreFailedAssemblies) throw;
                    // Ignore this assembly.
                }
            }
        }

        void EvaluateResult(CompilerResults result)
        {
